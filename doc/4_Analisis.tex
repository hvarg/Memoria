...
A modo de resumen se tiene que, para los datos consultados por los usuarios a
DrugBank:
\begin{enumerate}
  \item
...
%TODO: Faltan los problemas encontrados: completitud, maximalidad del grafo
%generado para calcular la centralidad; tiempo computacional para calcular la
%centralidad: posibles formas de reducirla, aproximaciones, etc.
