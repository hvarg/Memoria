...
\begin{figure}[ht]
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addlegendentry{Consultas}
      \addplot[mark=none,red,thick,dashed] coordinates {
        (2013-04-01,444190) (2015-10-01,444190)
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[>={Stealth[black]},every edge/.style={draw=black,very thick}]
      \path[->] (a) edge node[above] {\tt{?b}} (c);
      \path[->] (c) edge node[above] {\tt{?d}} (e);
    \end{scope}
  \end{tikzpicture}
...
En síntesis tenemos que los recursos parte del vocabulario no presentan casi
