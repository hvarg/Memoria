...
necesario que la clausula tenga argumentos (\tt{CONSTRUCT WHERE \{...\}} ),
...
adecuado. Un grafo dirigido (o digrafo) en aquel en el cual los arcos son pares
...
importancia a los nodos y partes del grafo más conectadas con el resto del mismo.
...
Por último, la \bf{centralidad de vector propio} determina cuales son los nodos
...
de cercanía más natural que consiste en calcular el reciproco de la anterior: 
\begin{equation}
  \label{eq:clo}
...
En la tabla~\ref{tab:exoth} se presentan los resultados el cálculo de las
